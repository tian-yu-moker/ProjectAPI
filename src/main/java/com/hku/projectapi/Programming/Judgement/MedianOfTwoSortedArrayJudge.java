...
public class MedianOfTwoSortedArrayJudge
{
    private MedianOfTwoSortedArraysAnswer medianOfTwoSortedArraysAnswer;
    private String filePath;
    private ProgrammingQuestionBean programInfo;
    private String uuid;

    public MedianOfTwoSortedArrayJudge(ProgrammingQuestionBean programInfo, String filePath, String uuid)
    {
        this.medianOfTwoSortedArraysAnswer = new MedianOfTwoSortedArraysAnswer();
    ...
    public JudgeResult doJudge() {
        try {
            ...
            for(GeneralBean cases:testCases){
                ...
                double resTruth = this.medianOfTwoSortedArraysAnswer.findMedianSortedArrays(param1, param2);
